#ifndef CUSTOMWIDGET_FORM_WIDGET_PURCHASE_HPP
#define CUSTOMWIDGET_FORM_WIDGET_PURCHASE_HPP
...
{
  class FormWidgetPurchase : public MultiWidgets::Widget
  {
  public:
    FormWidgetPurchase(MultiWidgets::Widget * parent = 0);
    virtual ~FormWidgetPurchase();
    void setupTheFormWidgetPurchase(float x, float y);
