...
{
  FormWidgetPurchase::FormWidgetPurchase(MultiWidgets::Widget * parent)
      : Widget(parent)
  {
  ...
  FormWidgetPurchase::~FormWidgetPurchase()
  {}

  void FormWidgetPurchase::setupTheFormWidgetPurchase(float x, float y)
  {
      bg =  new MultiWidgets::ImageWidget(parent());
      bg->load("forms/purchase/p_bg.png");
      bg->setSize(766,656);
...
//      timer->hide();
      ...
      rules->load("forms/purchase/rules.png");
      ...
      accept->load("forms/purchase/accept.png");
      ...
      t860->load("forms/purchase/860.png");
      ...
      t890->load("forms/purchase/890.png");
      ...
      t890_2->load("forms/purchase/890_2.png");
      ...
      t940->load("forms/purchase/940.png");
      ...
      t1080->load("forms/purchase/1080.png");
      ...
      t1400->load("forms/purchase/1400.png");
      ...
      troad->load("forms/purchase/road.png");
      ...
      ttrail->load("forms/purchase/trail.png");
      ...
      tother->load("forms/purchase/other.png");
      ...
      selected->load("forms/purchase/null.png");
  ...
  void FormWidgetPurchase::input(MultiWidgets::GrabManager & gm, float dt)
 {
   Widget::input(gm, dt);
...
//   }
  ...
  void FormWidgetPurchase::processMessage(const char * id, Radiant::BinaryData & data)
  {
      ...
      if(strcmp(id, "accepted") == 0)
      {
          ...
          if(m_accepted)
          {
            accept->load("forms/purchase/accept2.png");
          }
          if(!m_accepted)
          {
              accept->load("forms/purchase/accept.png");
        ...
        {
            FILE * CustomerData = fopen("customerData/customerDataPurchase.txt", "a");
...
//            timer->hide();
        ...
        if(strcmp(id, "rules") == 0)
        {
            ...
            rules1->setupTheImageWithClose("forms/rules.png",
                                                bg->location().x,bg->location().y, bg->rotation(), 500,500);
            rules1->hide();
        }
  ...
  CUSTOM_WIDGET(FormWidgetPurchase, "queue.formwidgetpurchase", "winkerVSbecks",
                "Form Widget Purchase", "NewBalance");
}
